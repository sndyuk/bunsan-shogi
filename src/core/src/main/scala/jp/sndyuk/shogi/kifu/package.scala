...
import jp.sndyuk.shogi.core.Point
  ...
  case class Kifu(version: Option[Version], kifuData: List[KifuStatement], startState: StartState, moves: List[KifuStatement], winner: Option[Turn]) extends KifuStatement
